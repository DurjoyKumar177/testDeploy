"""
Django settings for TuitionVault project.
...
SECRET_KEY = 'django-insecure-w8dcxwn_5it^a2(0m=)3dh7!u&09!vfrzd22svc)o^lsx3lkyt'
...
WSGI_APPLICATION = 'TuitionVault.wsgi.application'
